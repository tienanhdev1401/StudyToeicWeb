												...
												<div class="col-lg-8 col-md-8">
													...
													<form action="#" method="POST">
                                                        ...
                                                        <div class="mt-10">
                                                            ...
                                                            <textarea id="message" class="single-textarea" placeholder="Message" onfocus="this.placeholder = ''"
                                                        ...
                                                        <div class="mt-10">
                                                            ...
                                                            <input type="text" id="accent_color" name="accent_color" placeholder="Accent color"
                                                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Accent color'" required
                                                                class="single-input-accent"/>
                                                        </div>
                                                        <div class="mt-10">
                                                            <label for="secondary_color">Secondary Color</label>
                                                            <input type="text" id="secondary_color" name="secondary_color" placeholder="Secondary color"
